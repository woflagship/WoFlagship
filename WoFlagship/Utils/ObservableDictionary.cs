...
namespace WoFlagship.Utils
{
       ...
       INotifyPropertyChanged
    {
        ...
        protected class KeyedDictionaryEntryCollection<TTKey> : KeyedCollection<TTKey, DictionaryEntry>
        {
            #region constructors  
            ...
            public KeyedDictionaryEntryCollection(IEqualityComparer<TTKey> comparer) : base(comparer) { }
            ...
            protected override TTKey GetKeyForItem(DictionaryEntry entry)
            {
                return (TTKey)entry.Key;
            }
